package com.destiny.daudioolayer.util;
...
//        }
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    private static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color,
                                                int statusBarAlpha) {
//        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
//            return;
//        }
...
//        }
    ...
    public static boolean flymeSetStatusBarLightMode(Window window, boolean dark) {
        ...
        if (window != null) {
            try {
                ...
                Log.e("zjl", "flymeSetStatusBarLightMode: ");
            }
        }
        return result;
    }
     ...
     */
    private static int setStatusBarLightMode(Activity activity) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
...
//                View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN|
    ...
    public static void setStatusWhite(Activity activity) {
        ...
        Log.i("zjl", "setStatusWhite: " + setStatusBarLightMode(activity));
    }
}
